...
const ModeratorPanel: React.FC<PanelProps> = ({ currentUser, users, setUsers }) => {
  ...
  return (
    <div className="bg-white/60 backdrop-blur-md rounded-2xl shadow-lg w-full p-6 sm:p-8">
      ...
      <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-6 text-center">Moderator Panel</h2>
      <div className="max-w-7xl mx-auto">
        <h3 className="text-xl font-semibold text-slate-700 mb-4">User Management (Students)</h3>
          ...
          <table className="min-w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-slate-100/80">
              <tr>
                ...
                <th className="p-4 font-semibold text-slate-600">University</th>
